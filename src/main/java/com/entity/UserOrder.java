...
public class UserOrder implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5457433346104538141L;
		...
		public String toString() {
			return "UserOrder [id=" + id + ", order_no=" + order_no + ", user_id=" + user_id + ", user=" + user
					...
					+ send_time + ", end_time=" + end_time + ", close_time=" + close_time + ", create_time="
					+ create_time + ", update_time=" + update_time + ", orderItems=" + orderItems + "]";
		}
